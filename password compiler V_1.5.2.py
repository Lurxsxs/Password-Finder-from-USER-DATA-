...
combinazioni = [nome, cognome, anno, mese, giorno, mese[1:], abbrevanno, ".", "_", "!", shortname4, shortname3,
                maiuscnome, maiusccognome, fullmaiuscnome, fullmaiusccognome]
